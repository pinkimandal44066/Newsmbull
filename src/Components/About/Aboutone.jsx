...
//       once: false,    // Animations will repeat on scroll
//       offset: 200,    // Trigger animation slightly earlier
//     });
//   }, []);

//   return (
//     <div
//       className=" bg-gradient-to-br from-green-400  via-[#ffd54f] via-yellow-600 to-black
//  shadow-lg transition-transform transform lg:mx-10 mx-5 mt-10 rounded-xl"
//       data-aos="fade-up" // Animation for the container
//     >
//       <div className="w-full py-10">
//         <div className="max-w-screen-xl mx-auto px-4 md:px-8 lg:px-16">
//           <div className="flex flex-col lg:flex-row items-center gap-8">
//             {/* Left Image Section */}
//             <div
//               className="w-full lg:w-1/2 order-1 lg:order-1 flex justify-center lg:justify-start"
...
//             <div
//               className="w-full lg:w-1/2 order-2 lg:order-2 space-y-4 text-gray-800"
...
//               <p className="text-center lg:text-left text-base lg:text-lg mt-4">
//                 Welcome to SMBULL, where we bridge the gap between brands and
//                 influencers to create impactful partnerships that resonate with
//                 audiences around the globe. In a world where authenticity
//                 matters, we understand the power of influence. Our mission is
//                 to connect brands with the right influencers who can bring
//                 their vision to life. With a keen understanding of market
//                 trends and consumer behavior, we tailor strategies that not
...
//                 <NavLink
//                   to="/about"
//                   className="px-4 py-2 text-base lg:text-lg font-bold text-white bg-[#a6c465]
//                    rounded-md no-underline transition-colors duration-300 hover:bg-[#6c9f38]"
...
const HeroSection = () => {
  ...
  return (
    <div
      className=" bg-gradient-to-br from-green-400  via-[#ffd54f] via-yellow-600 to-black
 shadow-lg transition-transform transform lg:mx-10 mx-5 mt-10 rounded-xl "
 data-aos="zoom-in" // Animation for the container
    >
      <div className="w-full py-10">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            >
              <div className="flex flex-col lg:flex-row justify-center lg:justify-start lg:space-x-2 text-2xl lg:text-3xl text-center lg:text-left">
                <h1 className="mb-4 lg:mb-0">SMBULL</h1>
                <ReactTyped
                  className="text-[#e4f3b5] font-bold"
                  strings={[
                    "Mobile App Development",
                    "UI/UX Design",
                    "Web Development",
              ...
              <p className="text-center lg:text-left text-base  text-white lg:text-lg mt-4">
                Welcome to SMBULL, where we bridge the gap between brands and
                influencers to create impactful partnerships that resonate with
                audiences around the globe. In a world where authenticity
                matters, we understand the power of influence. Our mission is
              ...
              <div className="flex justify-center lg:justify-start">
                <NavLink
                  to="/about"
                  className="px-4 py-2 text-base lg:text-lg font-bold text-white bg-[#6c9f38]
                   rounded-md no-underline transition-colors duration-300  hover:bg-black"
                  data-aos="zoom-in" // Animation for the button
                >
                  Read More
                </NavLink>
