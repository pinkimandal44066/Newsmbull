  ...
  return (
    <>
      <div className="bg-[#8E9A4A] text-white font-sans">
        <div className="relative flex flex-col lg:flex-row">
          {/* Left Section */}
          <div className="bg-gradient-to-br from-[#ffafbd] via-[#ffc3a0] via-[#ff677d] via-[#d4a5a5] via-[#392f5a] to-[#5b86e5] w-full lg:w-1/2 py-10 px-8 lg:px-16 lg:py-20">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 mt-5">
              CAREER FAIR
            </h1>
            <p className="text-base lg:text-lg mb-8">
          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-[#ffafbd] via-[#ffc3a0] via-[#ff677d] via-[#d4a5a5] via-[#392f5a] to-[#5b86e5] py-10 px-6 lg:py-20 lg:px-12 flex flex-wrap items-center justify-center gap-4">
            {[...Array(7)].map((_, index) => (
              <div
                key={index}
                className="w-20 h-20 lg:w-32 lg:h-32 bg-white rounded-full flex items-center justify-center"
              >
                <img
                  src={`https://img.freepik.com/free-photo/cheerful-young-asian-businesswoman-using-laptop_171337-724.jpg`}
                  alt="Career Fair"
                  className="w-full h-full object-cover"
                />
              </div>
      ...
      {/* Form Section */}
      <div className="bg-gradient-to-br from-[#ffafbd] via-[#ffc3a0] via-[#ff677d] via-[#d4a5a5] via-[#392f5a] to-[#5b86e5] mb-10">
        <div className="flex items-center justify-center">
          <div className="w-full max-w-md p-4 text-gray-800 mt-10 shadow-lg rounded-lg bg-white flex flex-col mb-10">
            <h1 className="text-2xl font-bold mb-3 text-center">
              Join Our Influencer Team
            </h1>
            <form onSubmit={handleSubmit} className="flex flex-col">
              ...
              <label className="mb-1 font-semibold" htmlFor="resume">
                Upload Resume
              </label>
              <input
                type="file"
