...
// // Slide Content
// const slideContent = [
//   { description: "Leading the digital world with impactful content." },
//   { description: "Turning creativity into influence and engagement." },
//   { description: "A voice that inspires and drives trends online." },
//   { description: "Shaping opinions and setting new digital standards." },
//   { description: "Creating connections between brands and their audiences." },
//   { description: "Empowering people through authentic digital presence." },
//   { description: "Influencing and innovating in the world of social media." },
// ];
...
//             {/* Text Content with White and #ffd54f Gradient */}
//             {/* <div
//   className={`slide-text z-20 text-transparent animate-gradient
//      bg-gradient-to-r    from-black  via-fuchsia-600 to-red-500
//      bg-clip-text`}
//   style={{ position: "absolute" }}
// >


// <h2 className="text-3xl lg:text-5xl font-bold mb-2 lg:mb-4 transition-all duration-300 
// hover:bg-gradient-to-r hover:from-[#ff0000]
//  hover:via-[#00ff00] hover:to-[#0000ff]
//   hover:from-[#ffff00] hover:via-[#ff00ff] hover:to-[#00ffff] hover:bg-clip-text">
//   {slideContent[index].description}
// </h2>
...
// >
//   <h2
//     className="text-sm sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 sm:mb-3 lg:mb-4 transition-all duration-300
//       hover:bg-gradient-to-r hover:from-[#1f1e1e]
//       hover:via-[#00ff00] hover:to-[#0000ff]
//       hover:from-[#ffff00] hover:via-[#ff00ff] hover:to-[#00ffff] hover:bg-clip-text"
//   >
//     {slideContent[index].description}
